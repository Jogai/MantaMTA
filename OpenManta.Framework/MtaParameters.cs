...
namespace OpenManta.Framework
{
    public class MtaParameters
    {
        ...
        public static string MTA_DROPFOLDER
        {
            get
            {
                if (_MtaDropFolderLoadTime < DateTime.UtcNow)
                {
                    ...
                    if (_MtaDropFolder.StartsWith("~"))
                    {
                        _MtaDropFolder = _MtaDropFolder.Replace("~", AppDomain.CurrentDomain.BaseDirectory);
                    }
        ...
        {
            get { return Path.Combine(MTA_DROPFOLDER, "abuse"); }
        }
        ...
        {
            get { return Path.Combine(MTA_DROPFOLDER, "bounce"); }
        }
        ...
        {
            get { return Path.Combine(MTA_DROPFOLDER, "feedback"); }
        }
        ...
        {
            get { return Path.Combine(MTA_DROPFOLDER, "postmaster"); }
        }
        ...
        public static string MTA_QUEUEFOLDER
        {
            get
            {
                if (_MtaQueueFolderLoadTime < DateTime.UtcNow)
                {
                    ...
                    if (_MtaQueueFolder.StartsWith("~"))
                    {
                        _MtaQueueFolder = _MtaQueueFolder.Replace("~", AppDomain.CurrentDomain.BaseDirectory);
                    }
        ...
        public static string MTA_SMTP_LOGFOLDER
        {
            get
            {
                if (_MtaLogFolderLoadTime < DateTime.UtcNow)
                {
                    ...
                    if (_MtaLogFolder.StartsWith("~"))
                    {
                        _MtaLogFolder = _MtaLogFolder.Replace("~", AppDomain.CurrentDomain.BaseDirectory);
                    }
